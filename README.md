# OLED pictiva 288x48
A REAL and fully working library for the <b>Osram Pictiva OLED 288x48</b>, made in Germany, great quality but design Failed like Wolkswagen! They have a 288 pixel display but they are using a 96 pixel chip to drive it so they failed by using the r,g,b pixels of the SSD chip as addressing, this caused the premature dead of this display.<br>
